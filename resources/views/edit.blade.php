...
@section('content')
    ...
    <div class="bg-gray-200 h-screen px-8 py-4">
        ...
        <div class="title flex items-center justify-center">
            <p class="text-3xl">EDIT CATATAN</p>
        </div>
                ...
                <form action="/edit/{{ $note->id }}" method="post">
                    ...
                    <div class="mb-4 grid grid-cols-[10%_90%] gap-4">
                        ...
                        <input type="text" id="judul"
                            ...
                            placeholder="" required name='judul' value="{{ $note->judul }}"/>
                    </div>
                    <div class="grid grid-cols-[10%_90%] gap-4 mb-4">
                        ...
                        <textarea name="isi" id="" cols="30" rows="10"
                            class="rounded-lg bg-gray-50 border-gray-300 text-gray-900">{{ $note->isi }}</textarea>
                    </div>
